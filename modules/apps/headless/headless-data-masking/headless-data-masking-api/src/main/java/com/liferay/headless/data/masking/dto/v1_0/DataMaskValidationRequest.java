...
@GraphQLName(
	...
	value = "DataMaskValidationRequest"
)
...
@XmlRootElement(name = "DataMaskValidationRequest")
public class DataMaskValidationRequest implements Serializable {

	public static DataMaskValidationRequest toDTO(String json) {
		return ObjectMapperUtil.readValue(
			DataMaskValidationRequest.class, json);
	}

	public static DataMaskValidationRequest unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The input string the candidate mask is applied to. Returned in DataMaskValidationResult.output after redaction."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.data.masking.dto.v1_0.DataMaskValidationRequest",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-1550231811