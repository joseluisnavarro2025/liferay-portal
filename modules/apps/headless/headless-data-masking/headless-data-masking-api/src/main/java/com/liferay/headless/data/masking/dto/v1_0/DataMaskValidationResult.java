...
@GraphQLName(
	...
	value = "DataMaskValidationResult"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "DataMaskValidationResult")
public class DataMaskValidationResult implements Serializable {

	public static DataMaskValidationResult toDTO(String json) {
		return ObjectMapperUtil.readValue(DataMaskValidationResult.class, json);
	}

	public static DataMaskValidationResult unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			DataMaskValidationResult.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Set when the candidate regex failed to compile (or threw at apply time). Diagnostic message for the admin UI to surface inline. When present, output is the unredacted sampleText."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Number of distinct detection matches found in sampleText."
	)
	public Integer getMatchCount() {
		if (_matchCountSupplier != null) {
			matchCount = _matchCountSupplier.get();

			_matchCountSupplier = null;
		}
	...
	public void setMatchCount(
		...
		_matchCountSupplier = () -> {
			try {
				return matchCountUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<Integer> _matchCountSupplier;
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.data.masking.dto.v1_0.DataMaskValidationResult",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-1787669119