...
package com.liferay.headless.data.masking.client.resource.v1_0;
...
public interface DataMaskResource {
	...
	public HttpInvoker.HttpResponse validateDataMaskHttpResponse(
			DataMaskValidationRequest dataMaskValidationRequest)
		throws Exception;
	...
	public static class DataMaskResourceImpl implements DataMaskResource {
		...
		public DataMaskValidationResult validateDataMask(
			...
			HttpInvoker.HttpResponse httpResponse =
				validateDataMaskHttpResponse(dataMaskValidationRequest);
			...
			try {
				return DataMaskValidationResultSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse validateDataMaskHttpResponse(
			...
			httpInvoker.body(
				dataMaskValidationRequest.toString(), "application/json");
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-data-masking/v1.0/data-masks/validate");
...
// LIFERAY-REST-BUILDER-HASH:366366226