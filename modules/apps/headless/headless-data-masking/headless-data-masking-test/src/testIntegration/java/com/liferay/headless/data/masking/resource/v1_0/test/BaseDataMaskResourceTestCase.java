...
import com.liferay.headless.data.masking.client.http.HttpInvoker;
import com.liferay.headless.data.masking.client.pagination.Page;
import com.liferay.headless.data.masking.client.resource.v1_0.DataMaskResource;
...
public abstract class BaseDataMaskResourceTestCase {
	...
	protected void assertEquals(
		DataMaskValidationResult dataMaskValidationResult1,
		DataMaskValidationResult dataMaskValidationResult2) {

		Assert.assertTrue(
			dataMaskValidationResult1 + " does not equal " +
				dataMaskValidationResult2,
			equals(dataMaskValidationResult1, dataMaskValidationResult2));
	}
	...
	protected void assertValid(
		...
		for (String additionalAssertFieldName :
				getAdditionalDataMaskValidationResultAssertFieldNames()) {
			...
			if (Objects.equals("matchCount", additionalAssertFieldName)) {
	...
	protected String[] getAdditionalDataMaskValidationResultAssertFieldNames() {
		return new String[0];
	}
	...
	protected boolean equals(
		...
		if (dataMaskValidationResult1 == dataMaskValidationResult2) {
			return true;
		}
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("error", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						dataMaskValidationResult1.getError(),
						dataMaskValidationResult2.getError())) {
			...
			if (Objects.equals("matchCount", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						dataMaskValidationResult1.getMatchCount(),
						dataMaskValidationResult2.getMatchCount())) {
			...
			if (Objects.equals("output", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						dataMaskValidationResult1.getOutput(),
						dataMaskValidationResult2.getOutput())) {
	...
	protected DataMaskValidationResult randomDataMaskValidationResult()
		throws Exception {

		return new DataMaskValidationResult() {
			{
				error = RandomTestUtil.randomString();
				matchCount = RandomTestUtil.randomInt();
	...
	@Inject
	private com.liferay.headless.data.masking.resource.v1_0.DataMaskResource
		_dataMaskResource;

}
// LIFERAY-REST-BUILDER-HASH:-441179164