...
public abstract class BaseDataMaskResourceImpl implements DataMaskResource {
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-data-masking/v1.0/data-masks/validate' -d $'{"detectionRegex": ___, "replacementRegex": ___, "replacementValue": ___, "sampleText": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Compile a candidate data mask and apply it to sample text, returning the redacted output, the number of matches, and any compile/apply error. Used by the admin UI test card so the regex is evaluated by the same java.util.regex.Pattern engine that runs in production &mdash; eliminating JavaScript-vs-Java regex divergence as a source of false-positive validation."
	)
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "DataMask")}
	)
	@jakarta.ws.rs.Consumes({"application/json", "application/xml"})
	@jakarta.ws.rs.Path("/data-masks/validate")
	@jakarta.ws.rs.POST
...
// LIFERAY-REST-BUILDER-HASH:1001879425